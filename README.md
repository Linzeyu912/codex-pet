...
<p align="center">
  <img src="docs/images/qq-penguin.png" alt="黑白配色、橙色嘴脚的红围巾企鹅正面形象" width="192" />
</p>

<p align="center"><strong>把记忆里的红围巾企鹅，带回桌面。</strong></p>
...
走两步、挥挥手，再转身休息一下。以下展示来自实际运行时图集，桌面版与 Codex 内置版共用这些角色姿态。

<p align="center">
  <img src="docs/images/qq-penguin-poses.png" alt="企鹅动作图：第一排向左走，第二排向右走，第三排挥手、正面和背面，第四排倾倒、侧躺和恢复姿态" width="640" />
</p>

| 动作 | 看点 |
| --- | --- |
| 左右行走 | 同一条围巾尾端随朝向自然显露或遮挡 |
| 挥手与转身 | 保持统一的角色比例与脚底基线 |
| 侧躺与翻滚 | 桌面版通过连续姿态衔接动作 |
